        ...
        <!-- partial -->
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Add Publisher </h3>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="/publisher/store" method="POST">
                        @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" name="contact" class="form-control" id=""></input>
                        @error('contact')
                          <div class="bg bg-danger p-3 mt-2">{{$message}}</div>
                        @enderror
                      </div>
